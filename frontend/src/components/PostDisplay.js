    ...
    <div className="PostDisplay">
      ...
      <div className="PostDisplay-right">
        <div className="PostDisplay-edit-area">
          ...
          <i className="fas fa-edit text-primary" onClick={deletePost} />
        </div>
        <div className="PostDisplay-vote">
          <b>{votes} votes:</b>
          <i className="fas fa-thumbs-up text-success" onClick={e => submitVote('up')} />
          <i className="fas fa-thumbs-down text-success" onClick={e => submitVote('down')} />
        </div>
      </div>
    </div>
  )
